...
pub async fn navigate_to_redirect_url(
    ...
    ctx.insert_http_header(
        SET_COOKIE,
        format!(
            "oauth_client={}; HttpOnly; SameSite=None; Path=/; Secure",
    ...
    ctx.append_http_header(
        SET_COOKIE,
        format!(
            "j={}; Max-Age={}; HttpOnly; SameSite=None; Path=/; Secure",
            csrf_token.secret(),
    ...
    ctx.append_http_header(
        SET_COOKIE,
        format!(
            "k={}; Max-Age={}; HttpOnly; SameSite=None; Path=/; Secure",
    ...
    C: AuthMetadataContext + Sync,
{
    ...
    if let Some(new_refresh_token) = &token_pair.refresh_token {
        ctx.set_response_metadata(
            "set-cookie",
            &format!(
                "t={}; HttpOnly; SameSite=None; Path=/; Secure",
                new_refresh_token
            ),
        )
        .await;
